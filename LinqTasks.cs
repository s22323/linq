...
namespace LinqTutorials
{
    public static class LinqTasks
    {
        ...
        {
            IEnumerable<Emp> result = Emps.
                .Where(e => e.salary == Emps.Select(x => x.Salary).Max())
                .toList();
            return result;
        }
        ...
        public static int Task13(int[] arr)
        {
            int result = arr
                .GroubBy(x => x)
                .OrderByDescending(z => z.Count() % 2 !=0)
                .Select(z => z.Key)
                .First();
        ...
        public static IEnumerable<Dept> Task14()
        {
            IEnumerable<Dept> result = Depts
                .Join(Emps, d=>d.Deptno, e=>e.Deptno, (d,e) => new
                {
                    Departament = d,
                    Licznik = e.Count()
                }).
                .Where(x=> x.Licznik == 5 || x.Licznik == 0)
    ...
    public static class CustomExtensionMethods
    {
        ...
        {
            IEnumerable<Emp> result = emps
                .Where(e => emps.Any(x => x.Mgr == e.Mgr))
                .OrderBy(e=>e.Ename)
